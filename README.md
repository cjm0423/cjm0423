...
### 2. 청년정책·적금 혜택 추천 앱 ([↗ 저장소](https://github.com/cjm0423/2025SW))

`2025.04 ~ 2025.09` · SW 공모전 · **프론트엔드 · AI 추천 로직 담당**
...
### 6. VMLease — 멀티클라우드 VM 자동화 Kubernetes Operator
...
### 7. ONE WAVE — 취업 준비 청년을 위한 면접 회고·정서 지원 웹 ([↗ 저장소](https://github.com/2026-GDGoC-Hackathon-ONE-WAVE))
...
### 8. 캡스톤 매니저 — 프로젝트 협업 플랫폼 ([↗ 저장소](https://github.com/mk8048/Sanhak_CapstoneDesign))
